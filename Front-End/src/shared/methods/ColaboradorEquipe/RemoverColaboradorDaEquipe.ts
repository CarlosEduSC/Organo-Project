...
export const removerColaboradorDaEquipe = async (colaboradorEquipe: IColaboradorEquipe) => {
    ...
    try {
        const response = await api.delete("/colaborador-equipe/remover-colaborador", {data: { idColaborador: colaboradorEquipe.idColaborador, idEquipe: colaboradorEquipe.idEquipe }});
